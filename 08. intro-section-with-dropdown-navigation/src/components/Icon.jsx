...
export const ChevronDownIcon = createIcon({
  ...
  viewBox: '-3 -5 16 16',
  path: <path stroke="#686868" strokeWidth="1.5" fill="none" d="m1 1 4 4 4-4" />,
});

export const ChevronUpIcon = createIcon({
  displayName: 'ChevronUpIcon',
  viewBox: '-3 -5 16 16',
  path: <path stroke="#686868" strokeWidth="1.5" fill="none" d="m1 5 4-4 4 4" />,
});
...
export const CloseNavbarIcon = createIcon({
  displayName: 'CloseNavbar',
  viewBox: '0 0 26 26',
  path: [
    <path fill="#151515" fillRule="evenodd" d="m2.393.98 22.628 22.628-1.414 1.414L.979 2.395z" />,
    <path fill="#151515" fillRule="evenodd" d="M.98 23.607 23.609.979l1.414 1.414L2.395 25.021z" />,
  ],
});
...
export const Reminder = createIcon({
...
export const Planning = createIcon({
